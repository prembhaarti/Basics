...
public class InversionCount {
  ...
  /**
   *
   * divide basics.array into two half -> low:mid and mid+1:high
   * send each to mergeSort recursively one by one until size becomes 1.
   *
   * then start to merge from single element to whole basics.array.
   *
  ...
  /**
   * take two half of basics.array from low:mid and mid+1:high
   *
   * start to merge.
   * when elements taken from right basics.array means
   *     no. of elements in left basics.array from i to mid+1 position
   *     are greater than element on right basics.array and hence need inversion
  ...
  public static void main(String[] args) {
    ...
    //int[] basics.array= new int[]{1,9,4,3,8,6};
    int[] array= new int[]{5,1,6,2,3};
//    int[] basics.array= new int[]{2,4,1,3,5};
    //int[] basics.array= new int[]{3,9,1,8,4,5,0};
