...
public class FloorAndCeil {
  ...
  /**
   *
   * floor finding mean if num exist in basics.array print
   * else find lower value exists in basics.array
   *
   * first check boundary condition:
   * if num<arr[0] -> floor doesn't exist
   * if num>arr[size] -> last element of an basics.array is the floor
   *
