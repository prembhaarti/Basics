 ...
 * 2. create a basics.stack and push first interval
 * 3. start a loop from second interval to last interval
 * 4. get second interval from loop and peek interval from basics.stack and check if they can merge
 * 5. if the can merge, merge them after popping interval from basics.stack and push in basics.stack the merged interval
 * 6. if they can't merge push into basics.stack.
 */
