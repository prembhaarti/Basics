...
/**
 * Create an basics.array of size 10
 *
...
public class TwoStack {
    ...
    public int pop1(){
        if(top1==-1){
            throw new RuntimeException("basics.stack 1 Underflow");
        }
        else{
            return top1--;
        }
    ...
    public int pop2(){
        if(top2==array.length){
            throw new RuntimeException("basics.stack 2 Underflow");
        }
        else{
            return top2++;
        }
    ...
    public void push1(int data){
        if(top1==array.length || top1==top2){
            throw new RuntimeException("basics.stack 1 overflow");
        }
        else{
            array[++top1]=data;
        }
    ...
    public void push2(int data){
        if(top2==-1 || top2==top1){
            throw new RuntimeException("basics.stack 2 overflow");
        }
        else{
            array[--top2]=data;
        }
