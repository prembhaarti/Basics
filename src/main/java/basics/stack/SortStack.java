...
/**
 * Given a basics.stack : [4,3,2,1]
 * you need to sort this basics.stack, can use a temporary basics.stack.
 *
 * traverse until main basics.stack is empty
 *      pop element from mainStack
 *
 *      if temporary basics.stack -> empty
