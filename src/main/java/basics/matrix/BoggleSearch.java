 ...
 *  using basics.matrix.
 *  Create basics.trie of words to find in basics.matrix:insert one by one
 *
 *  start to traverse basics.matrix
 *    create visited boolean basics.matrix of basics.matrix size for each element
 *    send current position visited
 *    and send in dfsMethod where pass basics.trie,String,visited, positions
 *      each time check word exist in basics.trie then add in result
 *      else check wordsStarts from method from basics.trie is true, do recursion
 */
