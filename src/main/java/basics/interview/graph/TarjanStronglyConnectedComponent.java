 ...
 * @author Tushar Roy
 *
 * Find strongly connected components of directed basics.graph.
 *
...
public class TarjanStronglyConnectedComponent {
    ...
    public List<Set<Vertex<Integer>>> scc(Graph<Integer> graph) {
        ...
        //tells if a vertex is in basics.stack or not
        onStack = new HashSet<>();

        //basics.stack of visited vertices
        ...
        //start from any vertex in the basics.graph.
    ...
    private void sccUtil(Vertex<Integer> vertex) {
        ...
        for (Vertex child : vertex.getAdjacentVertexes()) {
            ...
            } //if child is on basics.stack then see if it was visited before vertex's low time. If yes then update vertex's low time to that.
        ...
        //keep popping vertices out of basics.stack still you find current vertex. They are all part of one strongly
        //connected component.
