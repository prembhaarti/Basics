...
public class StronglyConnectedComponent {
    ...
    public List<Set<Vertex<Integer>>> scc(Graph<Integer> graph) {
        ...
        //populate basics.stack with vertices with vertex finishing last at the top.
        ...
        //Do a DFS based off vertex finish time in decreasing order on reverse basics.graph..
        visited.clear();
