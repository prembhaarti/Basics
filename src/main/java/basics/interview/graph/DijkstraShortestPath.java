...
public class DijkstraShortestPath {
    ...
    public Map<Vertex<Integer>,Integer> shortestPath(Graph<Integer> graph, Vertex<Integer> sourceVertex){
        ...
        //basics.heap + map data structure
        ...
        //iterate till basics.heap is not empty
        while(!minHeap.empty()){
            //get the min value from basics.heap node which has vertex and distance of that vertex from source vertex.
            ...
            for(Edge<Integer> edge : current.getEdges()){
                ...
                //if basics.heap does not contain adjacent vertex means adjacent vertex already has shortest distance from source vertex
