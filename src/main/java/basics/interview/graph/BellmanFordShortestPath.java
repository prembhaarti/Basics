 ...
 * @author Tushar Roy
 *
 * Write program for Bellman Ford algorithm to find single source shortest path in directed basics.graph.
...
public class BellmanFordShortestPath {
    ...
    public Map<Vertex<Integer>, Integer> getShortestPath(Graph<Integer> graph,
        ...
        //there is negative weight cycle in the basics.graph. Throw exception in that
        //case
        for (Edge<Integer> edge : graph.getAllEdges()) {
            Vertex<Integer> u = edge.getVertex1();
            Vertex<Integer> v = edge.getVertex2();
