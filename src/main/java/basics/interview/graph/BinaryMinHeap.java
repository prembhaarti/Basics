 ...
 * getKeyWeight - O(1)
 *
 * It is a combination of binary basics.heap and hash map
 *
 */
public class BinaryMinHeap<T> {
    ...
    /**
     * Checks where the key exists in basics.heap or not
     */
    ...
    /**
     * Add key and its weight to they basics.heap
     */
    ...
    /**
     * Get the basics.heap min without extracting the key
     */
    public T min(){
    ...
    /**
     * Checks with basics.heap is empty or not
     */
    ...
    /**
     * Returns the min node of the basics.heap
     */
    ...
    /**
     * Extract min value key from the basics.heap
     */
    public T extractMin(){
