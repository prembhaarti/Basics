...
public class FloydWarshallAllPairShortestPath {
    ...
    public int[][] allPairShortestPath(int[][] distanceMatrix) {
        ...
        //look for negative weight cycle in the basics.graph
        //if values on diagonal of distance basics.matrix is negative
        //then there is negative weight cycle in the basics.graph.
    ...
    public static void main(String args[]){
        ...
        System.out.println("Minimum Distance basics.matrix");
        for(int i=0; i < distance.length; i++){
