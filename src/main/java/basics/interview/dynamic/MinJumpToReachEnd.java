 ...
 * @author tusroy
 * 
 * Given an basics.array of non negative integers where each element represents the max
 * number of steps that can be made forward from that element. Write a function to 
 * return the minimum number of jumps to reach the end of the basics.array from first element
 * 
 * Solution 
