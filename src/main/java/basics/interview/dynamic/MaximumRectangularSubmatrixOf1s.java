...
import basics.interview.stackqueue.MaximumHistogram;
 ...
 * 
 * Given a 2D basics.matrix of 0s and 1s. Find largest rectangle of all 1s
 * in this basics.matrix.
 * 
 * Maintain a temp basics.array of same size as number of columns.
 * Copy first row to this temp basics.array and find largest rectangular area
 * for histogram. Then keep adding elements of next row to this temp
 * basics.array if they are not zero. If they are zero then put zero there.
