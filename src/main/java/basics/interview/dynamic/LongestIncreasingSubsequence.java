 ...
 * 
 * Find a subsequence in given basics.array in which the subsequence's elements are
 ...
 * if(arr[i] > arr[j]) { ToString[i] = max(ToString[i], ToString[j] + 1 }
 * 
...
public class LongestIncreasingSubsequence {
    ...
    public int longestSubsequenceWithActualSolution(int arr[]){
        ...
        //find the index of max number in ToString
        int maxIndex = 0;
