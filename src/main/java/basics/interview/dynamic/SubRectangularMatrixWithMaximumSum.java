 ...
 * @author tusroy
 * 
 * Write a program to find maximum sum rectangle in give 2D basics.matrix.
 * Assume there is at least one positive number in the 2D basics.matrix.
 * 
 * Solution:
 * Keep temp basics.array with size as number of rows. Start left and right from 0
 * and keep adding values for each row and maintain them in this temp basics.array.
