package basics.interview.dynamic;

/**
 * Date 09/15/2014
 * @author tusroy
 * 
 * Find maximum subsquare in a basics.matrix made up of Xs and Os such that all four sides of subsquare are Xs. It does not matter what is inside
 ...
 * 
 * Solution
 * Have another basics.matrix which is capable of holding 2 values hori and ver.
 * Ver stores how far vertically you can see Xs. Hori stores how far horizontally you can see Xs.
 * Once this basics.matrix is build look for biggest subsquare by getting min of hori and ver at each point and checking
 * if subsquare can be formed from value min to 1.
 * 
 * Test cases:
 * basics.Matrix entirely made up of Xs
 * basics.Matrix entirely made up of Os
 * basics.Matrix with Xs and Os but maximum subsquare is length 1
 */
