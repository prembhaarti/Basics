 ...
 * @author Tushar Roy
 *
 * Given an basics.array of non negative numbers and a total, is there subset of numbers in this basics.array which adds up
 * to given total. Another variation is given an basics.array is it possible to split it up into 2 equal
