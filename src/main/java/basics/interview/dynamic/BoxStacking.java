 ...
 * @author tusroy
 * 
 * Given different dimensions and unlimited supply of boxes for each dimension, basics.stack boxes
 ...
 * 3) Take ToString[] and result[] basics.array of same size as total boxes after all rotations are done
...
public class BoxStacking {
    ...
    public int maxHeight(Dimension[] input) {
        ...
        //find max in ToString[] and that will be our max height.
        //Result can also be found using result[] basics.array.
