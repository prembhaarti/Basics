package basics.interview.suffixprefix;
 ...
 * @author tusroy
 * 
 * Construct suffix basics.tree using Ukkonen's algorithm
 * 
 * Solution
 ...
 * S[i+1] then do nothing(resulting in implicit basics.tree)
 * 
 * Suffix Link:
...
public class SuffixTree {
    ...
    public void build(){
        ...
        //finally walk the basics.tree again and set up the index.
    ...
    /**
     * Do a DFS traversal of the basics.tree.
     */
    ...
    /**
     * Do validation of the basics.tree by comparing all suffixes and their index at leaf node.
     */
