package basics.interview.string;
...
public class LongestPalindromeSubstring {
    ...
    public int longestPalindromicSubstringLinear(char input[]) {
        ...
        //Total size will be 2*n + 1 of this new basics.array.
        ...
        //create temporary basics.array for holding largest palindrome at every point. There are 2*n + 1 such points.
        ...
        for(int i=0; i < newInput.length; ) {
            ...
            //set the longest value of palindrome around center i at ToString[i]
            T[i] = end - start + 1;
        ...
        //find the max palindrome in ToString and return it.
