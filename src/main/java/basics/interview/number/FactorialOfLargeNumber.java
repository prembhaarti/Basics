 ...
 * 
 * Solution 
 * Since result will be very large it cannot fit in long. We need to store result in basics.array
 * and do regular multiplication of result in basics.array with next number of factorial.
