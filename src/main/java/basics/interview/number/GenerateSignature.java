package basics.interview.number;

/**
 * You are given an basics.array of n elements [1,2,....n]. For example {3,2,1,6,7,4,5}. Now we create a signature of this
 * basics.array by comparing every consecutive pir of elements. If they increase, write I else write D.
 * For example for the above basics.array, the signature would be "DDIIDI". The signature thus has a length of N-1.
