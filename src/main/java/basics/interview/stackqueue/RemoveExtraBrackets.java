 ...
 * 
 * Solution 1
 * Keep a basics.stack. When non bracket character shows up just skip it.
 * When an opening bracket shows up just add it.
 * When closing bracket shows up, see if top of basics.stack is opening bracket. If yes
 * then just remove that from basics.stack else add closing bracket into the basics.stack.
 * 
 * Solution 2
 * This can be done without basics.stack as well. Keep count of open and close brackets.
...
public class RemoveExtraBrackets {
    ...
    public int remove(char input[]){
        ...
        for(int i=0; i < input.length; i++){
            ...
            if(input[i] == '('){
                ...
                //if top is opening bracket just remove from basics.stack else add closing bracket
        ...
        //characters from basics.stack in final result
        for(int i=0; i < input.length; i++){
    ...
    /**
     * This method does not uses basics.stack and does inplace conversion
     */
