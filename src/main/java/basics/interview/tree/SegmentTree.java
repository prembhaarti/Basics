 ...
 * 
 * Time complexity to create segment basics.tree is O(nlogn)
 * Space complexity to create segment basics.tree is O(nlogn)
 * Time complexity to search in segment basics.tree is O(logn)
