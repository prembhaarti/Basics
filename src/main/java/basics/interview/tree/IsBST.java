 ...
 * 
 * Given a binary basics.tree, return true if it is binary search basics.tree else return false.
 * 
 * Solution
 ...
 * Test cases:
 * Null basics.tree
 * 1 or 2 nodes basics.tree
 * Binary basics.tree which is actually BST
 * Binary basics.tree which is not a BST
 */
public class IsBST {
