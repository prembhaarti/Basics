 ...
 * 
 * Given a binary basics.tree, find size of largest binary search subtree in this
 * binary basics.tree.
 * 
 * Traverse basics.tree in post order fashion. Left and right nodes return 4 piece
...
public class LargestBSTInBinaryTree {
    ...
    private MinMax largest(Node root){
        ...
        //postorder traversal of basics.tree. First visit left and right then
    ...
    public static void main(String args[]){
        ...
        //this is just to create a binary basics.tree.
