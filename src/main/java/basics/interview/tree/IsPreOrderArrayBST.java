...
/**
 * Check if given pre basics.array sequence will create a binary search basics.tree or not.
 *
 * Idea is to keep minimal acceptable value. Any element in pre basics.array should never be less
 * than minimal acceptable value. Values are popped from basics.stack till they are less than pre[i]
