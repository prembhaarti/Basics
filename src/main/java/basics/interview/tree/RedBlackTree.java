...
public class RedBlackTree {
    ...
    /**
     * Main insert method of red black basics.tree.
     */
    ...
    /**
     * Main delete method of red black basics.tree.
     */
    ...
    /**
     * Main print method of red black basics.tree.
     */
    ...
    /**
     * Main validate method of red black basics.tree.
     */
    ...
    private Node insert(Node parent, Node root, int data) {
        if(root  == null || root.isNullLeaf) {
            //if parent is not null means basics.tree is not empty
            //so create a red leaf node
            if(parent != null) {
                return createRedNode(parent, data);
            } else { //otherwise create a black root node if basics.tree is empty
                return createBlackNode(data);
            }
        }

        //duplicate insertion is not allowed for this basics.tree.
        if(root.data == data) {
