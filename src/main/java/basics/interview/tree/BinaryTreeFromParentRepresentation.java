 ...
 * @author Tushar Roy
 *
 * Given an basics.array reprsentation of binary basics.tree where index is data while value at index is
 * parent create the binary basics.tree. Value of -1 indicates root node.
 * 
 * References:
