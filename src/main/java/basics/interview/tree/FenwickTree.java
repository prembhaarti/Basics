 ...
 * @author tusroy
 * 
 * Write a program to implement fenwick or binary indexed basics.tree
 * 
 * A Fenwick basics.tree or binary indexed basics.tree is a data structure providing efficient methods
 * for calculation and manipulation of the prefix sums of a table of values.
 * 
 * Space complexity for fenwick basics.tree is O(n)
 * Time complexity to create fenwick basics.tree is O(nlogn)
...
public class FenwickTree {
    ...
    /**
     * Start from index+1 if you updating index in original basics.array. Keep adding this value
     * for next node till you reach outside range of basics.tree
     */
    ...
    /**
     * Creating basics.tree is like updating Fenwick basics.tree for every value in basics.array
     */
