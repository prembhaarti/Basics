 ...
 *
 * Write a program to insert into an AVL basics.tree.
 * 
 * AVL basics.tree is self balancing binary basics.tree. Difference of height of left or right subtree
 * cannot be greater than one.
 * 
 * There are four different use cases to insert into AVL basics.tree
 ...
 * 
 * Follow rotation rules to keep basics.tree balanced.
 * 
 * At every node we will also keep height of the basics.tree so that we don't
 * have to recalculate values again.
 * 
 * Runtime complexity to insert into AVL basics.tree is O(logn).
 * 
 * References 
