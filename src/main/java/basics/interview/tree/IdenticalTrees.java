 ...
 * Test cases
 * Both basics.array should be same size and have exact same elements and first element should be same
 */
public class IdenticalTrees {
    ...
    /**
     * It might not work for duplicate elements in basics.array. For that you have to store
