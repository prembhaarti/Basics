 ...
 *
 * Given a binary basics.tree print its level order traversal in reverse
 * e.g           1
 *          2         3
 *        4    5    6   7
 * 
 ...
 * 
 * Solution
 * Maintain a basics.stack and queue. Do regular level order traversal but
 * put right first in the queue. Instead of printing put the result
 * in basics.stack. Finally print contents of the basics.stack.
 * 
