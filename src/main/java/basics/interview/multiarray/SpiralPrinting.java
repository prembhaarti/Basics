package basics.interview.multiarray;
 ...
 * @author Tushar Roy
 * 
 * Given a 2D basics.matrix(square or rectangular) print it in spiral way.
 * e.g 1 2 3
 *     4 5 6
 *     7 8 9 
 ...
 *    
 * Solution:
 * Keep 4 pointers which are bounds for this basics.matrix, up, down, left, right. Print each
