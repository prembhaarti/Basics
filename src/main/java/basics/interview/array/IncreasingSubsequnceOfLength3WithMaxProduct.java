 ...
 * Other basics.array keeps max on left size which is smaller than current element
...
public class IncreasingSubsequnceOfLength3WithMaxProduct {
    ...
    public int maxProduct(int arr[]){
        ...
        LGN[0] = 0;
        //This can be implemented using an AVL basics.tree instead of this way which will
