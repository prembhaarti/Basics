 ...
 * path to reach from beginning of any basics.array to end of any of the two arrays. We can switch from one basics.array
 * to another basics.array only at common elements.
 *
