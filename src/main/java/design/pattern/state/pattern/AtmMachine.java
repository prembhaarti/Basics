...
import design.pattern.state.pattern.state.HasPin;
import design.pattern.state.pattern.state.NoCash;
import design.pattern.state.pattern.state.HasCard;
import design.pattern.state.pattern.state.NoCard;
