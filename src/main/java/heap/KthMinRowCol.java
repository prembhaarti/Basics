...
/**
 * Matrix given sorted horizontally and vertically
 *             {10, 20, 30, 40},
 *             {15, 25, 35, 45},
 *             {24, 29, 37, 48},
 *             {32, 33, 39, 50}
 * have to find Kth minimum element in matrix.
 *
 * Create a min heap -> add first row elements in that
 ...
 *  go one down row+1,col and add that matrix element in heap
 *
